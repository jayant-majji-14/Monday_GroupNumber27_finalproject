...
public abstract class Organization {
    ...
    public enum Type{
        ...
        Radiology("Radiology Organization"),ResearchScientist("ResearchScientist Organization"),ResearchAssistant("ResearchAssistant Organization"),Nutritionist("Nutritionist Organization"),Coach("Coach Organization");
